...
- Enable **Dependabot** to check updates periodically (weekly) on relevant ecosystems (`composer`, `npm`, `github-actions`); the `dependabot.yml` config file follows the Dependabot Config convention.